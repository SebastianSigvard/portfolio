            ...
            <div className="container">
                ...
                <nav style={{display : displayNav}}>
                    ...
                    <ul className="primary-nav">
                        <li><a href="/">            {styles["home"] === "bold"? <b>Home</b> : "Home" }</a></li>
                        <li><a href="cal-count">    {styles["cal-count"] === "bold"? <b>Calories Counter</b> : "Calories Counter" }</a></li>
                        <li><a href="market-status">{styles["market-status"] === "bold"? <b>Market Status</b> : "Market Status" }</a></li>
                    </ul>
