      ...
      return(
        <div className="container">
          ...
          <form id="registration-form" className="main-panel">
              ...
              <br/><input id="user-name-reg" type="text" placeholder="Enter Username" name="userName" value={this.state.userName} onChange={this.handleChange} required/>
              <br/><label><strong>Password</strong></label>
              <br/><input id="password-reg" type="password" placeholder="Enter Password" name="password" value={this.state.password} onChange={this.handleChange} required/>
              <br/>
